...
*/
/*
ALTER TABLE tip_klienta ADD PRIMARY KEY (id_tip_klienta);
ALTER TABLE field_of_industry ADD PRIMARY KEY (id_field);
ALTER TABLE district ADD PRIMARY KEY (id_district);
ALTER TABLE tip_kontaktov ADD PRIMARY KEY (id_tip_kontaktov);
ALTER TABLE kontakty ADD PRIMARY KEY (id_kontakty);
...
--VALUES (1, '996551266996', 1, 1), (2,'996551266996', 1, 2),(3, '996551266996', 1, 3), (4,'ayana@gmail.com', 2,4);
/*
